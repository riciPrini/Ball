...
public class Explosion : MonoBehaviour {
    ...
    void Start()
    {
       ...
       // material = FindObjectOfType<SaveData>().LoadColor();
       
    }
/*public Material mat(string color)
    {
        switch (color)
        {
            case "red":
    ...
    void createPiece(int x, int y, int z)
    {
        ...
        FindObjectOfType<Renderer>().material = redMaterial;
        //FindObjectOfType<Renderer>().material = Red;
